...
def run_simulation(user_params):
    return case11main_droopPlant_vsmPlant.main_droopPlant_vsmPlant(user_params)
...
def visualization(testResults):
    ...
    with col2:
        ...
        heatmap_fig = px.imshow(np.array(heatmap_data).T,
...
def main():
    st.title("Droop Plant + VSM Plant Analysis")
