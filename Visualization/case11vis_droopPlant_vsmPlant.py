...
def visualization(testResults):
    ...
    state_variables = [
        ...
        "iod(IBR1)", "ioq(IBR1)",
        "thetaPlant(IBR1)", 'epsilonPLLPlant(IBR2)', 'wPlant(IBR2)', 'epsilonP(IBR2)', 'epsilonQ(IBR2)',
        'PoPlant(IBR2)', 'QoPlant(IBR2)', 'PsetDelay(IBR2)', 'QsetDelay(IBR2)', 'theta(IBR2)', 'Po(IBR2)', 'Qo(IBR2)',
        'phid(IBR2)', 'phiq(IBR2)', 'gammad(IBR2)', 'gammaq(IBR2)', 'iid(IBR2)', 'iiq(IBR2)', 'vcd(IBR2)', 'vcq(IBR2)',
        'iod(IBR2)', 'ioq(IBR2)',
