...
def ssmodel_vsmPlant_vsmPlant(wbase, parasIBR1, parasIBR2, parasLine1, parasLine2, parasLoad,
    ...
    # Row 1
    row1_block1 = A1 + Bw1 @ Cw1.T + B1 @ Ngen1 @ C1  # Use Cw1.T instead of Cw1
    ...
    # Row 2
    row2_block1 = Bw2 @ Cw1.T  # Use Cw1.T instead of Cw1
    ...
    # Row 3
    row3_block1 = Bwline1 @ Cw1.T + B1line1 @ Ngen1 @ C1  # Use Cw1.T instead of Cw1
    ...
    # Row 4
    row4_block1 = Bwline2 @ Cw1.T  # Use Cw1.T instead of Cw1
    ...
    # Row 5
    row5_block1 = Bwload @ Cw1.T  # Use Cw1.T instead of Cw1
