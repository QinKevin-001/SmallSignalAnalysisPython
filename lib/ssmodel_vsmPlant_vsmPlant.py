...
def ssmodel_vsmPlant_vsmPlant(wbase, parasIBR1, parasIBR2, parasLine1, parasLine2, parasLoad,
    ...
    # Row 1
    row1_block1 = A1 + np.outer(Bw1, Cw1) + B1 @ Ngen1 @ C1  # Use np.outer instead of matrix multiplication
    ...
    # Row 2
    row2_block1 = np.outer(Bw2, Cw1)  # Use np.outer instead of matrix multiplication
    ...
    # Row 3
    row3_block1 = np.outer(Bwline1, Cw1) + B1line1 @ Ngen1 @ C1  # Use np.outer instead of matrix multiplication
    ...
    # Row 4
    row4_block1 = np.outer(Bwline2, Cw1)  # Use np.outer instead of matrix multiplication
    ...
    # Row 5
    row5_block1 = np.outer(Bwload, Cw1)  # Use np.outer instead of matrix multiplication
    ...
    # Asys dimensions before deletion: (48,48)
